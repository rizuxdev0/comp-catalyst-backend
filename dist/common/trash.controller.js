...
let TrashController = class TrashController {
    ...
    createTrash(data, req) {
        const userId = req.user.id || req.user.userId;
        return this.svc.create({ ...data, deleted_by: userId });
    }
    updateTrash(id, data) { return this.svc.update(id, data); }
    deleteTrash(id) { return this.svc.delete(id); }
};
exports.TrashController = TrashController;
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List trash items' }),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TrashController.prototype, "deleteTrash", null);
exports.TrashController = TrashController = __decorate([
    (0, swagger_1.ApiTags)('trash-bin'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, common_1.Controller)('trash_bin'),
